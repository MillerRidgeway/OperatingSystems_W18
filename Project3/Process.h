...
public:
   ...
   */
  Process(const std::string &file_name_, mem::MMU &memory_, PageTableManager &ptm_, int procNum, int ts);
  ...
  /**
   * isTerm - Check if a process is terminated
   */
  bool isTerm();
